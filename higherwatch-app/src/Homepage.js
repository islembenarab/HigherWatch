                    ...
                    <div className="container" style={{marginTop: '80px'}}>
                        <div className="row">
                            <div className="col-md-6">
                                <div>
                                    <div>
                                        <h1 className="pop-up">Project Management Platform</h1>
                                        <p className="home-paragraph"> Manage and Monitor<br/>
                                            Your Project
                                        </p>
                            ...
                            <div className="col-md-6 col-lg-1 offset-lg-0">
                                <div></div>
                                <img src={require("./assets/img/IT.png")} alt={'logo'} className="it"/>
