            ...
            <div>
                <main>
                    ...
                    <div className="container py-md-5">
                        <h2 className="display-6 fw-bold mb-4">Faculty Dean Space</h2>
                        <div className="row d-flex align-items-center">
                            ...
                            <div className="col-md-5 col-xl-4 text-center text-md-start">
                                ...
                                <Link to="/DepartmentHeadSpaceDemand" className="btn btn-primary shadow d-block w-100" role="button"
                                      style={{ marginLeft: '50px', marginRight: '54px'}}>
                                    Consult list of Demands
                                </Link>
...
export default FacultyDeanSpace1;
