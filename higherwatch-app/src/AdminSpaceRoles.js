                        ...
                        <div className="container py-md-5">
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-md-5 col-xl-4 text-center text-md-start">
                                    <h2 className="display-6 fw-bold mb-4">Create Roles</h2>
                                    <p className="text-muted">Add Roles for Users</p>
                                    <form method="post">
                                        <div className="mb-3"><input className="shadow form-control" type="text"
                                                                     name="RoleName" placeholder="RoleName" required/></div>
                                        <div className="mb-5">
                                            <button className="btn btn-primary shadow" type="submit">Add Role
                                            </button>
                                        </div>
...
export default AdminSpaceRoles;
