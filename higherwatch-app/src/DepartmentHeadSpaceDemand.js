...
function DepartmentHeadSpaceDemand() {
    return (
        <div>
            <header>
                <nav className="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav">
                    <div className="container" >
                        ...
                        <div className="collapse navbar-collapse" id="navcol-1">
                            <img src={require("./assets/img/hw5.png")} className="hw" />
                    ...
                    <div className="container py-md-5">
                        <div className="row d-flex align-items-center">
                            ...
                            <div className="col-md-5 col-xl-4 text-center text-md-start">
                                <h2 className="display-6 fw-bold mb-4"> Demand Form</h2>
                                <form method="post">


                                    <div className="mb-3">
                                        <label htmlFor="sexInput" className="form-label">Project Type</label>
                                        <select className="form-select" name="ProjectType" id="ProjectType input" required>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="birthdayInput" className="form-label">Date</label>
                                        <input type="date" className="form-control" name="Date" id="DateInput" required/>
                                    </div>

                                    <div className="mb-3">
                                        <label htmlFor="DescriptionInput" className="form-label">Demand Description</label>
                                        <textarea className="form-control" name="Description" id="DescriptionInput" required></textarea>
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        <button className="btn btn-primary shadow d-block w-100" type="submit">Submit
                                        </button>
                                    </div>
...
export default DepartmentHeadSpaceDemand;
