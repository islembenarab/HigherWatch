            ...
            <div>
                <main>
                    ...
                    <div className="container py-md-5">
                        <h2 className="display-6 fw-bold mb-4">Service Head Space</h2>
                        <div className="row d-flex align-items-center">
                            ...
                            <div className="col-md-5 col-xl-4 text-center text-md-start">
                                ...
                                <Link to="/Register" className="btn btn-primary shadow d-block w-100" role="button"
                                      style={{ marginLeft: '50px', marginRight: '54px'}}>
                                    Create The Contract
                                </Link> <br/>
                                <Link to="/AdminSpaceRoles" className="btn btn-primary shadow d-block w-100" role="button"
                                      style={{ marginLeft: '50px', marginRight: '54px' }}>
                                    Manage Projects
                                </Link> <br/>
                                <Link to="/AdminSpace1" className="btn btn-primary shadow d-block w-100" role="button"
                                      style={{ marginLeft: '50px', marginRight: '54px' }}>
                                    Show Statistics
                                </Link>
...
export default ServiceHeadSpace1;
