...
const ConsultDemandsDean = () => {
    ...
    const getDemands = async () => {
        ...
        const response = await api.get('demand/FacultyDean');
    ...
    const handleAcceptClick = async (row) => {
        ...
        try {
            const response = await api.put(`demand/FacultyDean/acceptedDemand`,updatedDemand);
    ...
    const handleRefusedClick = async (row) => {
        ...
        try {
            const response = await api.put(`demand/FacultyDean/refusedDemand`,updatedDemand);
            window.location.reload()
            return response.data;
        } catch (error) {
            console.error(error);
...
export default ConsultDemandsDean;