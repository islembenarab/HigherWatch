...
const DepartmentHeadSpace = () => {
  ...
  const handleCreateDemand =()=>{
    navigate("/CreateDemand")
    window.scrollTo(0, 0);
  }
  const HandleConsultDemands =()=>{
    navigate("/consultDemands");
    window.scrollTo(0, 0);
    ...
    <Box>
      ...
      >
        ...
        <Card sx={{ width: "100%" }}>
          ...
          <CardActions>
            <Button variant="contained" size="small" onClick={handleCreateDemand} >
              Create
            </Button>
          </CardActions>
        </Card>
        ...
        <Card sx={{ width: "100%" }}>
          ...
          <CardActions>
            <Button variant="contained" size="small" onClick={HandleConsultDemands}>
              Consult
            </Button>
          </CardActions>
        </Card>
